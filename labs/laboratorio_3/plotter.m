...
%% Problema 06 -----------------------------------------------------------------
    % A: Funcion X -------------------------------------------------------------
        ...
        xlabel('$$t$$', 'Interpreter', 'latex', 'FontSize', lfsz)
        ylabel('$$x$$', 'Interpreter', 'latex', 'FontSize', lfsz)
        % title('$$x\left(t\right)$$', 'Interpreter', 'latex', 'FontSize', Tfsz)
    ...
    % B: Funcion H -------------------------------------------------------------
        ...
        xlabel('$$t$$', 'Interpreter', 'latex', 'FontSize', lfsz)
        ylabel('$$h$$', 'Interpreter', 'latex', 'FontSize', lfsz)
        % title('$$h\left(t\right)$$', 'Interpreter', 'latex', 'FontSize', Tfsz)
    ...
    % B: Funcion Y = X * H -----------------------------------------------------
        ...
        print('problema06_conv','-dpng','-r600')
